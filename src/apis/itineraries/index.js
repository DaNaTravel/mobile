...
export const ItineraryRoutes = async (startDate, endDate, setData) => {
  let config = {
    ...
    url: `http://ec2-18-177-138-181.ap-northeast-1.compute.amazonaws.com:3000/routes?latitude=16.019110655988168&longitude=108.22903420822459&startDate=${startDate}&endDate=${endDate}`,
    headers: {
  ...
  await axios
    ...
    .then(async response => {
      ...
      await setData(response?.data?.data?.routes);
    })
    .catch(error => {
